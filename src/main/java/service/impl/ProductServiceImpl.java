...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public List<Product> getProductByIdCate(int cid) {
	    List<Product> list = ((ProductDaoImpl) productDao).getProductByIdCate(cid);
	    return list != null ? list : new ArrayList<>(); // ✅ bảo đảm không null
	}
