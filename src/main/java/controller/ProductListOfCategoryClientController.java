...
public class ProductListOfCategoryClientController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
        	String cid = req.getParameter("cid"); if (cid == null || cid.isEmpty()) cid = "1"; System.out.println("🟢 Danh mục hiện tại: " + cid);
         ...
         // Nếu service trả về null, thay bằng list rỗng
	         if (productList == null) {
	             productList = new ArrayList<>();
	             System.err.println("⚠️ productList is null, tạo list rỗng để tránh crash.");
	         }
	         ...
	         req.setAttribute("productlist", formattedList);
